#!/bin/bash
#SBATCH --job-name=lopo.1 # short name for your job
...
cd ${HOME}/PI-Thalamus/01\ Thalamus-PI/Paper_iESPnet_pruebas/05-Train-Test/exp_dsf_iespnet_lopo_early/

srun python3 dsf_iespnet_lopo_early_15_01.py