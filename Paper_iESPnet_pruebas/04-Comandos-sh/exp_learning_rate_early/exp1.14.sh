#!/bin/bash
#SBATCH --job-name=exp1.14 # short name for your job
...
cd ${HOME}/PI-Thalamus/01\ Thalamus-PI/Paper_iESPnet_pruebas/05-Train-Test/exp_learning_rate_early/

srun python3 exp1.14.py