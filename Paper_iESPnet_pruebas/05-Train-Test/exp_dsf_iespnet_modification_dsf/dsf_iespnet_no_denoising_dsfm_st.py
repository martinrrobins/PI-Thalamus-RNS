...
# Variables DSF
denoising             = 'no_denoising'  # 'autoreject'    'data_augm' 'no_denoising' 
model                 = 'stager_net'
dsf_type              = 'dsfm_st'       # 'dsfd'          'dsfm_st'
mlp_input             = 'logm_cov_eig'  # 'log_diag_cov'  'logm_cov_eig'
...
experiment = 'no_denoising_dsfm_st'
